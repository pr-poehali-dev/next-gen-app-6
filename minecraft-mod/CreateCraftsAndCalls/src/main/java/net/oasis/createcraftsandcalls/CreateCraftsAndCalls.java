...
import net.oasis.createcraftsandcalls.registry.ModMenus;
 ...
 * модульную телефонную станцию (растёт как сундук Create) и медный
 * телефонный кабель. Станция коммутируется гаечным ключом Create —
 * игрок вручную соединяет вход и выход, как настоящая телефонистка.
 * Голос передаётся через мод Simple Voice Chat (интеграция необязательная —
 * если SVC не установлен, звонки просто не будут передавать звук).
 */
